...
final class VoicePipeline: ObservableObject {
    ...
    private nonisolated func process(
        ...
        // ── Stage 5: Groq LLM (with tool support) ────────────────────────────
        // GroqService maintains the rolling in-session turn history internally.
        // If Groq calls add_calendar_event or add_reminder, ToolExecutor
        // dispatches to CalendarService and feeds the result back to Groq
